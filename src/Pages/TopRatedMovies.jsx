...
function TopRated({page, language, region, genre, adult, movies, render, append_movies, set_page, clear_movies}) {
    ...
    useEffect(() => {
        async function GetMovies() {
            SetMaxPage(await Api_TopRated(append_movies, page, language, region, genre, adult));
        }
