 ...
 */
export default async function TopRated (action, page, locale, region = "EN", genre = 0, adult) {
  return Common_Api(COOKIE_PREFIX, "/movie/top_rated", topRatedAxiosRequest, action, DAY_COOKIE_EXPIRY, page, locale, region, genre, adult);
}